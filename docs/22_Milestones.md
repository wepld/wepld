...
| **Required ADRs** | None are accepted by implication. Proposed ADR-0015–ADR-0025 may be reviewed in parallel but do not ratify the candidate. |
...
| **Required ADRs** | No new authority ADR is implied; any material transport/identity/data-flow change requires a new Proposed ADR. ADR-0015–ADR-0025 remain binding where accepted. |
