...
H2 evidence must exercise tailored phase graphs; invalid entry/exit transitions; WIP saturation; one writer per worktree; parallel read-only research; decision/effect backlog limits; phase return, defer, uncertainty, and recovery; and exact invalidation from specification-versus-plan changes.
