...
| Proposed ADR disposition | implementation-authorizing decisions are explicit | ADR-0015 through ADR-0026 are reviewed; each is accepted, revised, rejected, or deferred before dependent work | architecture package |
